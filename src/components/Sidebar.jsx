...
export default function SideBar() {
    return (
        <>
            <div className="static lg:sticky lg:top-[2.5rem] w-full lg:max-w-[450px]">
                <div className="flex flex-col gap-5 bg-[#161616] px-[2rem] py-[1.5rem] rounded-[2rem] border border-[#303033]">
                    <h2 className="text-3xl font-bold">
                        Hello Everyone <span className="wavingHands">👋</span>
                    </h2>
                    <img
                        src="..\..\assets\danial.png"
                        className="rounded-[3rem] h-[320px] object-cover"
                    />
